(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const d of s)if(d.type==="childList")for(const c of d.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function e(s){const d={};return s.integrity&&(d.integrity=s.integrity),s.referrerPolicy&&(d.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?d.credentials="include":s.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(s){if(s.ep)return;s.ep=!0;const d=e(s);fetch(s.href,d)}})();const Q=(o="Surtu 2")=>{const t=[{id:"Surtu 2",label:"Surtu 2",icon:'<svg class="w-6 h-6 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>'},{id:"Draft",label:"Draft",icon:'<svg class="w-6 h-6 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>'},{id:"Revisi",label:"Revisi",icon:'<svg class="w-6 h-6 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2"></path></svg>'}];return`
  ...
  `,F=()=>{const o=document.getElementById("processBtn"),t=document.getElementById("cookieContent"),e=document.getElementById("processingResults"),i=document.getElementById("copyBtn"),s=document.getElementById("copyText"),d=document.getElementById("cookieLoader"),c=document.getElementById("autoProcessPtk");c&&c.addEventListener("change",()=>{q=c.checked}),t&&(t.value=U,t.addEventListener("input",()=>{U=t.value})),e&&(e.value=$),i&&($?i.classList.remove("hidden"):i.classList.add("hidden"));const b=(g,r)=>{d&&(d.classList.remove("opacity-0","pointer-events-none"),d.classList.add("opacity-100")),setTimeout(()=>{r(),d&&(d.classList.remove("opacity-100"),d.classList.add("opacity-0","pointer-events-none"))},g)};i&&i.addEventListener("click",async()=>{const g=e.value;if(g)try{await navigator.clipboard.writeText(g);const r=s.innerText;s.innerText="Tersalin!",i.classList.replace("bg-zinc-800","bg-green-600"),i.classList.replace("hover:bg-zinc-700","hover:bg-green-500"),i.classList.replace("border-zinc-700","border-green-500"),setTimeout(()=>{s.innerText=r,i.classList.replace("bg-green-600","bg-zinc-800"),i.classList.replace("hover:bg-green-500","hover:bg-zinc-700"),i.classList.replace("border-green-500","border-zinc-700")},2e3)}catch(r){console.error("Failed to copy text: ",r)}}),t&&t.addEventListener("input",()=>{const g=t.value,r=/([a-zA-Z0-9]{26}|202[0-9]-[A-Z0-9.-]+)/g,_=g.match(r);if(_&&_.length>0){const w=_.join(`
`);g.replace(r,"").trim().length>0&&b(600,()=>{t.value=w})}}),o&&o.addEventListener("click",async()=>{const g=t.value;if(!g.trim()){e.value="Silakan masukan terlebih dahulu teks atau No SSM / PTK untuk diproses.",e.classList.add("text-red-500"),i&&i.classList.add("hidden");return}e.classList.remove("text-red-500");const r=/([a-zA-Z0-9]{26}|202[0-9]-[A-Z0-9.-]+)/g,_=g.match(r);if(_&&_.length>0){o.disabled=!0,o.textContent="Mencari Data...",e.value="Sedang mengambil data dari server, mohon tunggu...";let w="";const x=async(p,a)=>{const h=new Date().toISOString().split("T")[0];let v="";const n=/(\d{4})(0[1-9]|1[0-2])(0[1-9]|[12]\d|3[01])/,k=p.match(n);if(k&&parseInt(k[1])>=2020)v=`${k[1]}-${k[2]}-${k[3]}`;else{const E=/(?:EXT|IMP|DOM)(\d{2})(0[1-9]|1[0-2])(0[1-9]|[12]\d|3[01])/,L=p.match(E);if(L)v=`20${L[1]}-${L[2]}-${L[3]}`;else{const N=new Date;N.setFullYear(N.getFullYear()-1),v=N.toISOString().split("T")[0]}}let f="3200";const I=localStorage.getItem("userData");if(I)try{f=JSON.parse(I).upt||"3200"}catch{}const B={dFrom:v,dTo:h,stat:"",karantina:"",upt:f,jnsAju:"EKSPOR",jeniscari:a,noAju:p};try{const E=await fetch("https://api.karantinaindonesia.go.id/ssm/getAju",{method:"POST",headers:{Authorization:"Basic bXJpZHdhbjpaPnV5JCx+NjR7KF42WDQm","Content-Type":"application/json"},body:JSON.stringify(B)});if(!E.ok)return null;const L=await E.json();return L.status&&L.data&&L.data.length>0?L.data[0]:null}catch{return null}},l=await new Promise(p=>{const a=localStorage.getItem("accessToken")||localStorage.getItem("token");if(a){p(a);return}if(typeof chrome<"u"&&chrome.cookies)chrome.cookies.getAll({domain:"apps.karantinaindonesia.go.id"},h=>{const v=h.find(n=>n.name==="token");p(v?v.value:"")});else{const h=document.cookie.match(/(?:^|; )token=([^;]*)/);p(h?h[1]:"")}}),u=_.map(async p=>{var I,B,E,L;let a=`
--- MENCARI AJU: ${p} ---
`,h="",v="";const[n,k]=await Promise.all([x(p,"noAju"),x(p,"noReg")]);let f=n||k;if(f){if(v=f.ptk_id||f.id||"",f.noReg&&(h=f.noReg),v&&l)try{const y=await fetch(`https://api.karantinaindonesia.go.id/barantin-sys/ptk/${v}`,{headers:{Authorization:`Bearer ${l}`}});if(y.ok){const T=await y.json();(B=(I=T==null?void 0:T.data)==null?void 0:I.ptk)!=null&&B.no_dok_permohonan&&(h=T.data.ptk.no_dok_permohonan)}}catch(y){console.error("Failed to fetch PTK details",y)}let N="-",P="-",j="-",M=null;if(f.xml)try{M=JSON.parse(f.xml);const y=(L=(E=M==null?void 0:M.DOKUMEN)==null?void 0:E.ITEMS)==null?void 0:L.BARANG;if(y&&y.length>0){const T=y[0];N=T.URAIAN?T.URAIAN.trim():"-",P=`${T.NETTO||"-"} ${T.JNSSATUAN||""}`.trim(),j=`${T.JMLKEMAS||"-"} ${T.JNSKEMAS||""}`.trim(),y.length>1&&(N+=` (+${y.length-1} item lainnya)`)}}catch(y){console.error("Failed parsing xml",y)}let S="",R="";if(R+=`[DEBUG] Token      : ${l?"ADA":"KOSONG"}
`,R+=`[DEBUG] XML Parsed : ${M?"BERHASIL":"GAGAL/KOSONG"}
`,R+=`[DEBUG] Checkbox   : ${c&&c.checked?"DICENTANG":"TIDAK DICENTANG"}
`,c&&c.checked&&M)if(!l)S+=`Status PTK     : GAGAL (Sesi Token tidak ditemukan. Silakan ke menu Login terlebih dahulu)
`;else try{const y=localStorage.getItem("userData"),T=y?JSON.parse(y):{},D=te(f,M,T),C=await fetch("https://api.karantinaindonesia.go.id/barantin-sys/ssm",{method:"POST",headers:{Authorization:`Bearer ${l}`,"Content-Type":"application/json"},body:JSON.stringify(D)});if(C.ok||C.status===201){const G=await C.json();if(G.status==="201"||G.status===!0){S+=`Status PTK     : BERHASIL DIBUAT (ID: ${D.id})
`;const z=await fetch("https://api.karantinaindonesia.go.id/ssm/sendStatus/ptk",{method:"POST",headers:{Authorization:`Bearer ${l}`,"Content-Type":"application/json"},body:JSON.stringify({id:f.id,ptk_id:D.id,noReg:f.noReg||f.noAju})});z.ok||z.status===201?S+=`Verifikasi     : BERHASIL (GA - PROSES VERIFIKASI)
`:S+=`Verifikasi     : GAGAL DIPROSES
`}else S+=`Status PTK     : GAGAL (${G.message||"Unknown Error"})
`}else S+=`Status PTK     : GAGAL (HTTP ${C.status})
`}catch(y){S+=`Status PTK     : ERROR (${y.message})
`}a+=S,a+=R,a+=`Status         : DITEMUKAN (${f.jnsAju})
`,a+=`No Aju SSM     : ${f.noAju||"-"}
`,a+=`No Dokumen     : ${h||f.noReg||"-"}
`,a+=`Perusahaan     : ${f.nmPerusahaan||"-"}
`,a+=`Barang         : ${N}
`,a+=`Netto          : ${P}
`,a+=`Kemasan        : ${j}
`,a+=`Alat Angkut    : ${f.namaAngkut||"-"}
`,a+=`Tgl Tiba       : ${f.tglTiba||"-"}
`,a+=`Pelabuhan Asal : ${f.portAsal||"-"}
`,a+=`Pelabuhan Tuju : ${f.portTujuan||"-"}
`,a+=`Karantina      : ${f.jenis_karantina||"-"}
`,a+=`UPT            : ${f.upt||"-"}
`,a+=`
--- DATA JSON LENGKAP ---
`;const K={...f};if(K.xml)try{K.xml=JSON.parse(K.xml)}catch{}a+=JSON.stringify(K,null,2)+`
`}else a+=`Status         : TIDAK DITEMUKAN / GAGAL
`;return a});w=(await Promise.all(u)).join(""),e.value=w.trim(),$=w.trim(),o.disabled=!1,o.textContent="Proses Data",i&&i.classList.remove("hidden")}else e.value="Tidak ditemukan Nomor AJU SSM / PTK (26 karakter) yang valid pada teks.",$=e.value,i&&i.classList.add("hidden")})},W=()=>`
...
Done`})},ne=()=>{let o=localStorage.getItem("activeMenu")||"Surtu 2";o==="Profile"&&(o="Surtu 2",localStorage.setItem("activeMenu","Surtu 2"));let t="";return o==="Draft"?t=W():o==="Revisi"?t=X():o==="Surtu 2"?t=Z():t=`<div class="text-white text-center mt-10">Fitur ${o} belum tersedia</div>`,`
  ...
  `},ae=()=>{const o=document.getElementById("mainContent");let t=localStorage.getItem("activeMenu")||"Surtu 2";t==="Profile"&&(t="Surtu 2"),ee(e=>{localStorage.setItem("activeMenu",e),o&&(e==="Draft"?(o.innerHTML=W(),H()):e==="Revisi"?(o.innerHTML=X(),J()):e==="Surtu 2"?(o.innerHTML=Z(),F()):o.innerHTML=`<div class="text-white text-center mt-10">Fitur ${e} belum tersedia</div>`)}),t==="Draft"?H():t==="Revisi"?J():t==="Surtu 2"&&F()},oe=()=>`
  ...
  `,ie=o=>{const t=document.getElementById("loginSubmitBtn"),e=document.getElementById("loginError"),i=document.getElementById("username"),s=document.getElementById("password"),d=document.getElementById("captchaInput"),c=document.getElementById("captchaImage"),b=document.getElementById("refreshCaptchaBtn"),g=localStorage.getItem("savedUsername"),r=localStorage.getItem("savedPassword");g&&i&&(i.value=g),r&&s&&(s.value=r);let _="";const w=async()=>{try{const a=await fetch("https://api.karantinaindonesia.go.id/barantin-sys-v2/captcha?app=APP001");if(!a.ok)throw new Error("Failed to fetch captcha");const h=await a.json();h.status&&h.image&&(c==null||c.setAttribute("src",h.image),_=h.token)}catch(a){console.error("Error loading captcha:",a)}};w(),b&&b.addEventListener("click",w);let x="103.152.232.25";fetch("https://api.ipify.org/?format=json").then(a=>a.json()).then(a=>x=a.ip).catch(a=>console.error("Error fetching IP:",a));const A=()=>Promise.resolve({timestamp:Date.now(),coords:{accuracy:212,latitude:-6.577271,longitude:107.783081,altitude:null,altitudeAccuracy:null,heading:null,speed:null}}),l=async()=>{const a=i.value.trim(),h=s.value.trim(),v=d.value.trim();if(!a||!h||!v){e&&(e.classList.remove("hidden"),e.textContent="Harap isi semua kolom");return}t&&(t.disabled=!0,t.textContent="Memproses..."),e&&e.classList.add("hidden");try{const n=await A(),f=await(await fetch("https://api.karantinaindonesia.go.id/barantin-sys-v2/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:a,password:h,app:"APP001",ipaddress:x,captcha:v,captchaToken:_,location:n})})).json();f.status?(localStorage.setItem("savedUsername",a),localStorage.setItem("savedPassword",h),f.data&&(localStorage.setItem("accessToken",f.data.accessToken),localStorage.setItem("userData",JSON.stringify(f.data))),o()):(e&&(e.classList.remove("hidden"),e.textContent=f.message||"Login gagal"),s.value="",d.value="",w())}catch{e&&(e.classList.remove("hidden"),e.textContent="Terjadi kesalahan jaringan atau server tidak dapat dihubungi.")}finally{t&&(t.disabled=!1,t.textContent="Masuk")}};t&&t.addEventListener("click",a=>{a.preventDefault(),l()});const u=a=>{a.key==="Enter"&&(a.preventDefault(),l())};s&&s.addEventListener("keydown",u),d&&d.addEventListener("keydown",u);const m=a=>{const h=a.target;h.value.includes(" ")&&(h.value=h.value.replace(/\s/g,""))};i&&i.addEventListener("input",m),s&&s.addEventListener("input",m);const p=document.getElementById("togglePasswordBtn");p&&s&&p.addEventListener("click",()=>{const a=s.style.webkitTextSecurity==="disc";s.style.webkitTextSecurity=a?"none":"disc",p.innerHTML=a?'<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>':'<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"></path></svg>'})},re="modulepreload",se=function(o,t){return new URL(o,t).href},V={},de=function(t,e,i){let s=Promise.resolve();if(e&&e.length>0){const c=document.getElementsByTagName("link"),b=document.querySelector("meta[property=csp-nonce]"),g=(b==null?void 0:b.nonce)||(b==null?void 0:b.getAttribute("nonce"));s=Promise.allSettled(e.map(r=>{if(r=se(r,i),r in V)return;V[r]=!0;const _=r.endsWith(".css"),w=_?'[rel="stylesheet"]':"";if(!!i)for(let l=c.length-1;l>=0;l--){const u=c[l];if(u.href===r&&(!_||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${r}"]${w}`))return;const A=document.createElement("link");if(A.rel=_?"stylesheet":re,_||(A.as="script"),A.crossOrigin="",A.href=r,g&&A.setAttribute("nonce",g),document.head.appendChild(A),_)return new Promise((l,u)=>{A.addEventListener("load",l),A.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${r}`)))})}))}function d(c){const b=new Event("vite:preloadError",{cancelable:!0});if(b.payload=c,window.dispatchEvent(b),!b.defaultPrevented)throw c}return s.then(c=>{for(const b of c||[])b.status==="rejected"&&d(b.reason);return t().catch(d)})};function le(o={}){const{immediate:t=!1,onNeedReload:e,onNeedRefresh:i,onOfflineReady:s,onRegistered:d,onRegisteredSW:c,onRegisterError:b}=o;let g,r;const _=async(x=!0)=>{await r};async function w(){if("serviceWorker"in navigator){if(g=await de(async()=>{const{Workbox:x}=await import("./workbox-window.prod.es5-BqEJf4Xk.js");return{Workbox:x}},[],import.meta.url).then(({Workbox:x})=>new x("./sw.js",{scope:"./",type:"classic"})).catch(x=>{b==null||b(x)}),!g)return;g.addEventListener("activated",x=>{(x.isUpdate||x.isExternal)&&(e?e():window.location.reload())}),g.addEventListener("installed",x=>{x.isUpdate||s==null||s()}),g.register({immediate:t}).then(x=>{c?c("./sw.js",x):d==null||d(x)}).catch(x=>{b==null||b(x)})}}return r=w(),_}le({immediate:!0});const Y=()=>{const o=document.getElementById("app");o&&(localStorage.getItem("isAuthenticated")==="true"?(o.innerHTML=ne(),ae()):(o.innerHTML=oe(),ie(()=>{localStorage.setItem("isAuthenticated","true"),Y()})))};document.addEventListener("DOMContentLoaded",Y);
